    ...
    protected function __open_close_style_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}}.ha-accordion--icon-left .ha-accordion__icon > span i' => 'font-size: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}}.ha-accordion--icon-right .ha-accordion__icon > span i' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
