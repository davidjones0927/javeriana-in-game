		...
		protected function __tab_title_style_controls() {
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors'          => [
						'{{WRAPPER}}.ha-loop-tab .ha-loop-tab-wrapper .ha-loop-tab-nav .ha-loop-tab-nav-item' => 'width: {{SIZE}}{{UNIT}};',
						'{{WRAPPER}}.ha-loop-tab .ha-loop-tab-wrapper .ha-loop-tab-nav' => 'grid-template-columns: repeat(2, {{SIZE}}{{UNIT}});',
						'{{WRAPPER}}.ha-loop-tab .ha-loop-tab-wrapper .ha-loop-tab-nav .ha-loop-tab-nav-item .ha-loop-tab-svg-container .tab-svg' => 'width: {{SIZE}}{{UNIT}}',
						'{{WRAPPER}}.ha-loop-tab .ha-loop-tab-wrapper .ha-loop-tab-nav .ha-loop-tab-nav-item .ha-loop-tab-svg-container .tab-svg .tab-border' => 'width: {{SIZE}}{{UNIT}}'
					],
					'style_transfer'     => true,
					'frontend_available' => true,
					'render_type'        => 'template'
		...
		protected function __tab_icon_style_controls() {
			...
			$this->add_control(
				...
				[
					...
					'type'               => Controls_Manager::COLOR,
					'selectors'          => [
						'{{WRAPPER}}.ha-loop-tab .ha-loop-tab-wrapper .ha-loop-tab-nav .ha-loop-tab-nav-item:hover .ha-loop-tab-title-icon i' => 'color: {{VALUE}}',
						'{{WRAPPER}}.ha-loop-tab .ha-loop-tab-wrapper .ha-loop-tab-nav .ha-loop-tab-nav-item:hover .ha-loop-tab-title-icon svg' => 'fill: {{VALUE}}',
					],
					'style_transfer'     => true,
					'frontend_available' => true
				]
